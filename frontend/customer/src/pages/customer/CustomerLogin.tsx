...
import { Mail, Lock, Eye, EyeOff, User as UserIcon, Phone, AlertCircle, Loader2, CheckCircle2, ArrowLeft } from 'lucide-react';
...
export const CustomerLogin: React.FC = () => {
  ...
  return (
    <div className="min-h-screen lg:h-screen bg-[#070707] text-white flex flex-col justify-between relative overflow-x-hidden">
      ...
      {/* Desktop Right Side Hero Burger Container — Fully Filling Desktop View */}
      <div className="hidden lg:block absolute inset-y-0 right-0 w-[55%] xl:w-[58%] pointer-events-none overflow-hidden z-0">
        <div className="relative w-full h-full">
          ...
          />
          {/* Soft Dark Gradient overlays blending naturally into dark negative space */}
      ...
      {/* Main Content Area — Exact Admin Login Dimensions Specification */}
      <div className="relative z-10 flex-1 flex items-center justify-center lg:w-[50%] xl:w-[48%] lg:pl-[8vw] lg:justify-center px-4 sm:px-12 lg:px-8 py-6 my-auto">
        <div className="w-full max-w-[520px] bg-[#121212] border border-[#222222] rounded-2xl p-6 sm:p-14 sm:py-16 shadow-2xl shadow-black/90 my-auto flex flex-col justify-between">
          <div>
            {/* Industry Standard Patty Project Brand Logo (Asset from /images/logo.jpeg) */}
            ...
            {/* Success Alert Box */}
            {successMessage && (
              <div className="mb-6 bg-[#122718] border border-[#22C55E]/40 text-[#86EFAC] text-xs font-semibold px-4 py-4 rounded-xl flex items-center gap-2.5 animate-fadeIn">
            ...
            {mode === 'login' && (
              <div className="flex flex-col justify-between flex-1 w-full">
                <div>
                  <h1 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight text-center">Login</h1>
                ...
                <form onSubmit={handleLoginSubmit} autoComplete="off" className="mt-6 space-y-6">
                  {/* Email Address Field */}
                ...
                <div className="relative my-9 text-center">
                  ...
                  <span className="relative bg-[#121212] px-3.5 text-[11px] font-medium text-[#6B7280]">
                    or continue with
                  </span>
                </div>
                ...
                <div className="space-y-4">
                  <button
                    ...
                    className="w-full bg-[#181818] hover:bg-[#222222] border border-[#282828] text-white font-semibold text-xs py-4 px-4 rounded-xl flex items-center justify-center gap-2.5 transition-colors cursor-pointer"
                  >
                    <svg className="w-4 h-4" viewBox="0 0 24 24">
                      ...
                      <path fill="#34A853" d="M12 24c3.2 0 6-1.1 8-3l-3.7-2.9c-1.1.7-2.5 1.2-4.3 1.2-3 0-5.5-2.3-6.4-5.2L1.9 17C3.7 20.7 7.5 22.3 12 24z" />
                    </svg>
                ...
                <p className="text-center text-xs text-[#9CA3AF] mt-9 font-medium">
          ...
          {mode === 'register' && (
            <div className="flex flex-col justify-between flex-1 w-full">
              <div>
                <div>
                  <h1 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight text-center">Create Account</h1>
                  <p className="text-xs sm:text-sm text-[#9CA3AF] text-center mt-3 leading-relaxed">
                    Join Patty Project rewards today and receive 100 welcome bonus points!
                  </p>
                </div>

                <form onSubmit={handleRegisterSubmit} className="mt-8 space-y-4.5">
                  <div className="space-y-2">
                    <label className="block text-xs font-semibold text-[#D1D5DB]">Full Name</label>
                    <div className="flex items-center bg-[#181818] border border-[#282828] focus-within:border-[#FF5500] rounded-xl px-4 py-4 transition-colors">
                      <UserIcon className="w-4 h-4 text-[#FF5500] mr-3 shrink-0" />
                      <input
                        type="text"
                        value={fullName}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center bg-[#181818] border border-[#282828] focus-within:border-[#FF5500] rounded-xl px-4 py-4 transition-colors">
                      <Phone className="w-4 h-4 text-[#FF5500] mr-3 shrink-0" />
                      <input
                        type="tel"
                        value={phone}
          ...
          {mode === 'forgot' && (
            <div className="flex flex-col justify-between flex-1 w-full">
              <div>
                <h1 className="text-2xl sm:text-3xl font-extrabold text-white tracking-tight text-center">Forgot Password?</h1>
                <p className="text-xs sm:text-sm text-[#9CA3AF] text-center mt-3 leading-relaxed">
