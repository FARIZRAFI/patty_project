...
export const CustomerLogin: React.FC = () => {
  ...
  return (
    <div className="min-h-screen lg:h-screen bg-[#070707] text-white flex flex-col justify-between relative overflow-x-hidden">
      {/* Desktop Right Side Hero Burger Container — Fully Filling & Fitting Desktop View */}
      ...
      <div className="relative z-10 flex-1 flex items-center justify-center lg:w-[50%] xl:w-[48%] lg:pl-[8vw] lg:justify-center px-4 sm:px-12 lg:px-8 py-6 my-auto">
        <div className="w-full max-w-[520px] bg-[#121212] border border-[#222222] rounded-2xl p-6 sm:p-14 sm:py-16 shadow-2xl shadow-black/90 my-auto flex flex-col justify-between">
          ...
          {/* Error Alert Box */}
          {error && (
            <div className="mb-5 bg-[#2A1215] border border-[#EF4444]/40 text-[#FCA5A5] text-xs font-semibold px-4 py-3 rounded-xl flex items-center gap-2.5 animate-fadeIn">
          ...
          {/* Success Alert Box */}
          {successMessage && (
            <div className="mb-5 bg-[#122718] border border-[#22C55E]/40 text-[#86EFAC] text-xs font-semibold px-4 py-3 rounded-xl flex items-center gap-2.5 animate-fadeIn">
      ...
      <footer className="relative z-10 py-3.5 text-center text-[11px] text-[#6B7280] font-medium border-t border-[#141414] bg-[#070707]">
