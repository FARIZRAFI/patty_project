...
export const CustomerFooter: React.FC = () => {
  return (
    <footer className="w-full bg-[#0A0A0A] border-t border-[#1C1C1C] pt-14 pb-8 text-white">
      <div className="max-w-[1720px] mx-auto px-6 sm:px-10 lg:px-16 xl:px-20 space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-10 xl:gap-12">
          ...
          <div className="space-y-4 lg:col-span-1">
            ...
            <div className="flex items-center gap-2.5 pt-2">
              <a
                ...
                className="w-8 h-8 rounded-full bg-[#161616] border border-[#262626] flex items-center justify-center text-[#9CA3AF] hover:text-[#FF5500] hover:border-[#FF5500]/50 hover:bg-[#1F1F1F] transition-all"
              >
              ...
              <a
                ...
                rel="noopener noreferrer"
                aria-label="TikTok"
                className="w-8 h-8 rounded-full bg-[#161616] border border-[#262626] flex items-center justify-center text-[#9CA3AF] hover:text-[#FF5500] hover:border-[#FF5500]/50 hover:bg-[#1F1F1F] transition-all font-bold text-xs"
              >
          ...
          <div className="space-y-4">
            ...
            <div className="relative rounded-2xl overflow-hidden border border-[#262626] bg-[#161616] group shadow-lg">
              <iframe
        ...
        <div className="pt-8 border-t border-[#1C1C1C] flex flex-col sm:flex-row items-center justify-between text-xs text-[#9CA3AF] gap-4">
