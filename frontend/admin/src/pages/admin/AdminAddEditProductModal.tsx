...
export const AdminAddEditProductModal: React.FC<Props> = ({ categories, product, onClose, onSuccess }) => {
  const [name, setName] = useState(product?.name || 'Buffalo Wings');
  ...
  const [allergens, setAllergens] = useState(product?.allergens || 'Contains Gluten, Milk, Mustard, Sesame seeds');
  const [ingredients, setIngredients] = useState(product?.ingredients || 'Beef Patty, American Cheese, Lettuce, Tomato, Onion, Pickles, Special Sauce');
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-[#1A1A1A] border border-[#262626] p-4 rounded-xl space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[#121212] border border-[#262626] rounded-xl py-2 px-3 text-xs text-white placeholder-[#6B7280] focus:outline-none focus:border-[#FF5500]"
                  />
                </div>
            ...
            <div className="space-y-6">
              ...
              {/* Product Preview Photos (Gallery Images for Customer View) */}
              <div className="bg-[#1A1A1A] border border-[#262626] p-4 rounded-xl space-y-4">
                <div className="flex items-center justify-between">
                  <div>
                ...
                <div className="space-y-2 pt-1">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 bg-[#121212] border border-[#262626] rounded-xl py-1.5 px-3 text-xs text-white placeholder-[#6B7280] focus:outline-none focus:border-[#FF5500]"
                    />
                    <button
                      type="button"
                      onClick={() => {
                      ...
                      className="bg-[#FF5500] hover:bg-[#E04B00] text-white px-3 py-1.5 rounded-xl text-xs font-bold disabled:opacity-40 cursor-pointer"
                    >
                      Add
                    </button>
                  </div>

                  <label className="flex items-center justify-center gap-2 w-full bg-[#121212] border border-dashed border-[#333333] hover:border-[#FF5500] rounded-xl py-2 px-3 text-xs text-[#9CA3AF] hover:text-white cursor-pointer transition-colors mt-1">
                    <Upload className="w-3.5 h-3.5 text-[#FF5500]" />
                    <span>Upload Preview Photo File...</span>
                    <input
                      type="file"
                      accept="image/*"
                      onChange={(e) => {
